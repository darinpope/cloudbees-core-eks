...
kubectl annotate -n ingress-nginx -f https://raw.githubusercontent.com/kubernetes/ingress-nginx/nginx-0.23.0/deploy/provider/aws/service-l4.yaml service.beta.kubernetes.io/aws-load-balancer-connection-idle-timeout="3600"
